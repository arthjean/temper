...
#[command(
    ...
    long_about = "Temper CLI and report schema version 1 are experimental. Interfaces may break during 0.x without a backward-compatibility promise."
)]
struct Cli {
    #[command(subcommand)]
    command: Command,
...
enum Command {
    ...
    ///
    /// Temper CLI and report schema version 1 are experimental. Interfaces may
